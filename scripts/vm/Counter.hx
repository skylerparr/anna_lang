...
class Counter {
  ...
  private static var _increment_Int__Void_0: Array<Operation> = {
    ...
    _increment_Int__Void_0.push(new InvokeFunction(IO.inspect, [Macros.tuple(['var'.atom(), 'count'])]));
  ...
  public static var _countdown_Int__Void_0: Array<Operation> = {
    ...
    _countdown_Int__Void_0.push(new InvokeFunction(IO.inspect, [Macros.tuple(['const'.atom(), 'subtracting'])]));
